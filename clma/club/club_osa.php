...
<div class="container">
    ...
    <?php
        ...
        function osa_admin_all_activity_query($osaInstructorId) {
            global $pdo;
            // echo "get id: " . $osaInstructorId . "<br>";
            try {
                ...
                $query = "
                    WITH club_ AS (
                        SELECT club.\"ID\"
                        FROM club
                        WHERE club.\"osa_instructor_ID\" = :osaInstructorId
                    )
                ...
                $statement->bindParam(':osaInstructorId', $osaInstructorId, PDO::PARAM_STR);
                $statement->execute();
        ...
        // Example usage
        $osaInstructorId = $ID;
        $results = osa_admin_all_activity_query($osaInstructorId);
