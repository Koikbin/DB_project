...
<div class="container">
    ...
    <div class="link-container">
        ...
        <a href="./venue/venue_condition.php" class="search-link">社團記點查詢</a><br></br><br></br>
        <a href="./club/club_account.php" class="search-link">社團帳戶動態查詢</a>
        <a href="./club/club_instructor.php" class="search-link">社團所有活動查詢</a><br></br><br></br>
        <a href="./club/club_instructor.php" class="search-link">社團活動申請查詢</a>
        <!-- 上包含審核 -->
