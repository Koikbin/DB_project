...
<div class="container">
    ...
    <div class="link-container">
        ...
        <a href="./club/participation.php?>" class="search-link">社團記點查詢</a>
        <br></br><br></br>
        <a href="./activity/application.php?>" class="search-link">社團活動申請</a>
        <a href="./club/participation.php?>" class="search-link">社團活動申請狀態查詢</a>
        <br></br><br></br>
        <a href="./club/club_activity.php?>" class="search-link">社團所有活動查詢</a>
    </div>
    <?php
